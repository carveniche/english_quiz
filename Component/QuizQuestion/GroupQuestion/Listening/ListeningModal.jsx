...
export default function ListeningModal({ group_data, onClick, from ,autoPlay,children}) {
  const handleClose = () => {
    ...
    <div>
      ...
      >
        ...
        >
         ...
         {children??   <ListeningPlayer audioUrl={group_data?.resources[0]?.url} autoPlay={autoPlay}/>}
          </Box>
        </div>
      </Modal>
    </div>
