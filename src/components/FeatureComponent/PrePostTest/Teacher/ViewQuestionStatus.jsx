...
import { viewPrePostTestQuestionResponse } from "../../../../api";
import TeacherViewEachResponse from "../../Mathzone/Teacher/TeacherViewEachResponse";
...
export default function ViewQuestionStatus({
  ...
  const handleApi = async () => {
    let { data } = await viewPrePostTestQuestionResponse({
      live_class_id,
      pre_post_test_id,
    });
    if (data.status) {
